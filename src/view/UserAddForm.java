	...
	public void opcaoCadUsuario(int option){
		...
		case 1:
			...
			while (checked) {
				...
				System.out.println("Login do usuario (deve ter menos de 20 caracteres e n�o pode ter n�meros):");
				dadosUser.add(3, entrada.nextLine());
				System.out.println("Senha do usuario (entre 8 e 12 caracteres e pelo menos 1 caracter e 2 n�meros):");					
